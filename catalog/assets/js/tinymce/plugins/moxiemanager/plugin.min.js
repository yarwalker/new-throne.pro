    ...
    define(__moxman_interop_TinyMcePlugin, [__moxman_Loader, __moxman_Env], function (Loader, Env) {
        tinymce.PluginManager.add("moxiemanager", function (editor, url) {
            ...
            editor.settings.file_browser_callback = function (id, value, type, win) {
                ...
                Loader.browse(tinymce.extend(settings, {zIndex: zIndex, url: editor.documentBaseURI.toAbsolute(value), document_base_url: editor.settings.document_base_url, view: type == "image" || type == "media" ? "thumbs" : "files", multiple: false, oninsert: function (args) {
            ...
            editor.addCommand("mceInsertFile", function (ui, value) {
                ...
                Loader.browse(tinymce.extend(settings, {zIndex: zIndex, view: editor.getParam("moxiemanager_default_view", "files"), document_base_url: editor.settings.document_base_url, oninsert: function (args) {
                    var html = "";
