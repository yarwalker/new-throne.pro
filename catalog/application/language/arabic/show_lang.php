...
$lang['top'] = '<div class="frame">
    <div id="head" class=" hidden-xs">
        ...
        <a id="logo" href="http://' . $_SERVER['SERVER_NAME'] . '/arabic" >THRONE Project</a>

        <ul id="top_menu_ext">
            <li><a href="http://' . $_SERVER['SERVER_NAME'] . '/arabic/about.html" title="عن الشركة">عن الشركة</a></li>
            <li><a href="http://' . $_SERVER['SERVER_NAME'] . '/arabic/installation.html" title="كيف نعمل">كيف نعمل</a></li>
        </ul>

        <div class="callback visible-lg visible-md">
            <span class="callback_button" data-toggle="modal" data-target="#myModal">طلب إتصال</span>
...
$lang['footer'] = '<footer class="minor visible-md visible-lg">
        ...
        <ul id="bottom_menu">
            <li><a href="http://' . $_SERVER['SERVER_NAME'] . '/arabic/about.html" title="عن الشركة">عن الشركة</a></li>
            <li><a href="http://' . $_SERVER['SERVER_NAME'] . '/arabic/installation.html" title="كيف نعمل">كيف نعمل</a></li>
            <li><a href="http://' . $_SERVER['SERVER_NAME'] . '/arabic" title="الصفحة الرئيسية">الصفحة الرئيسية</a></li>
        </ul>
