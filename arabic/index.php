            ...
            <ul class="slides">
                <li>
  	    		...
  	    		<li>
                    ...
                    <div class="flex-caption">
                        <span class="overlay"></span>
                        <h2 data-animation="animated pulse">نموذج تجريبي ثلاثي الأبعاد خاص بمنزلكم مجاناً !</h2>
                        <p>حتى قبل توقيع العقود، نحن نقدم مجاناً ولكافة عملائنا فرصة الحصول على تصور كامل حول كيفية عمل المنزل الذكي الخاص بهم،

وذلك من خلال نموذج تجريبي ثلاثي الأبعاد مصمم بناءً على مخططات العقار المطلوب تزويده بنظام البيت الذكي. بإمكانكم إرسال

مخططات منزلكم، وسنقوم بتصميم نموذج ثلاثي الأبعاد خاص بكم مجانا.</p>
                    </div>
  	    		</li>
  	    		<li>
                    ...
                    <div class="flex-caption">
                        ...
                        <p>البرنامج بإمكانه إدارة شقة صغيرة أو دار سكن ضخم، و إن عدد أجهزة وأنظمة البيت الذكي التي يمكن توصيلها لبرنامج التحكم غير

محدود. كذلك الأمر بالنسبة لأجهزة الحاسب اللوحية و(التابلت) والهواتف الذكية (السمارتفون).</p>
                    </div>
  	    		</li>
  	    		<li>
        ...
        <p class="text-center">التحكم بالإنتركم المنزلي وكاميرات المراقبة وكافة أجهزة السلامة والراحة وغيرها من الأنظمة التي تلعب دورا هاما في التوفير من

استهلاك الطاقة وتساهم في رفع درجة الامان. تلك هي الميزات الأهم التي يقدمها نظام البيت الذكي لمستخدميه، و بواسطة «مشروع

ترون» أصبحت جميع تلك الوظائف سهلة الادارة والتنفيذ حيث تم ترجمتها بطريقة حديثة من خلال واجهة موحده ثلاثية الأبعاد يتم

تثبيتها على الهاتف النقال (السمارتفون) او أجهزة الحاسب اللوحي (التابلت).</p>
    ...
    <div class="bcg" data-anchor-target="#slide-3" data-bottom-top="position: relative;  bottom: 0px;  " data--52-bottom="position: absolute;  bottom: 0px;">
        ...
        <div class="hsContainer visible-lg">
            <div class="hsContent">
                ...
                <p class="text-center" id="descr">لإدارة البيت الذكي نحن نقدم لعملائنا واجهة التحكم (انتيرفيس) "ترون" ثلاثية الأبعاد الفريدة من نوعها و التي لم ينتج مثيل لها

حتى الآن في العالم ، بوساطتها سيمكنكم متابعة الحالة العامة للمنزل و إدارة الأنظمة المختلفة فيه من خلال الهاتف النقال

الشخصي أو عن طريق عدد منها أو من أي جهاز تابلت. فابإمكانكم التحكم بكل من أجهزة البيت الذكي بشكل منفرد، أو بغرفة

معينة أو بطابق كامل أو بالبيت بأكمله. وإن القيام بكل تلك العمليات، أصبح أمراً بسيطاً جداً وبدرجةٍ من السهولة بشكل لم نعهده

من قبل وكل ذلك بفضل استخدام نظام "ترون" ثلاثي الأبعاد و المخصص لمنزلكم بالذات.</p>
    ...
    <div id="tabs" class="visible-lg">
        ...
        <div id="tabs-1">
            ...
            <table class="table">
                ...
                <tr>
                    <td width="60%" rowspan="2"><img src="/images/light_manage.jpg" alt="التحكم بالإنارة " title="التحكم بالإنارة " class="img-responsive tab_main_img col-xs-12"  /></td>
                    <td width="40%">
        ...
        <div id="tabs-2">
            <table class="table">
                ...
                <tr>
                    <td width="60%" rowspan="2"><img src="/images/climate_management.jpg" class="img-responsive tab_main_img  col-xs-12" alt="التحكم بالمناخ " title="التحكم بالمناخ "/></td>
                    <td>
                        <p class="">
        ...
        <div id="tabs-3">
            <table class="table">
                ...
                <tr>
                    <td width="60%" rowspan="2"><img src="/images/slide4_bg.jpg" class="img-responsive tab_main_img  col-xs-12" alt="إدارة انظمة الأمان" title="إدارة انظمة الأمان"/></td>
                    <td>
                        <p>"البيت الذكي ترون" يتيح تشغيل او إيقاف نظام الأمان و الإنذارفوريا بكامل المبنى او بكل طابق بشكل مستقل او في أقسام
معينة منه. التبليغ بحدوث طارئ ما يترافق مع تحديد المكان على النموذج الثلاثي الابعاد .</p>
                        <p>بواسطة " ترون" ، يمكنكم مشاهدة الفيديو من كاميرات المراقبة، تلقي الإنذارات حول نشوب حريق ما، تسرب غاز او مياه،
أو بحدوث أي تسلل إلى داخل المنزل .</p>
                        <p>وبتوصيل جهاز الإنتركم المنزلي لبرنامج ترون، يصبح ممكنا رؤية الزوار القادمين إليكم و فتح الأبوب الخارجية لهم مباشرة
عن طريق هاتفكم النقال او جهاز التابلت الخاص بكم .</p>
                    </td>
                </tr>
                <tr>
                    <td class="text-bottom">
            ...
            <table class="factoids">
                <tr>
                    ...
                    <td>
                        <img src="/images/security_sensors.jpg" alt="حساسات الحركة، ومستشعرات فتح النوافذ و الأبواب" title="حساسات الحركة، ومستشعرات فتح النوافذ و الأبواب"/>
                        <span>حساسات الحركة، ومستشعرات فتح النوافذ و الأبواب</span>
                    </td>
                    <td>
...
عن طريق هاتفكم النقال او جهاز التابلت الخاص بكم .</p>
            ...
            <table class="factoids">
                <tr>
                    ...
                    <td>
                        <img src="/images/security_sensors.jpg" alt="ححساسات الحركة، ومستشعرات فتح النوافذ و الأبواب" title="حساسات الحركة، ومستشعرات فتح النوافذ و الأبواب"/>
                        <span>حساسات الحركة، ومستشعرات فتح النوافذ و الأبواب</span>
                    </td>
                    <td>
                        <img src="/images/security_emergency.jpg" alt="حماية تامة من كافة أنواع التسريب و غيرها من الحالات الطارئة" title="حماية تامة من كافة أنواع التسريب و غيرها من الحالات الطارئة"/>
...
<div id="slide-5" data-slide="5" class=" frame">
    ...
    <div class="table hidden-xs" id="integr_table">
        <div class="table_row">
            ...
            <div class="table_cell">
                <div class="integr_description">كل أحوال المناخ
يمكن رؤيتها من
على شاشة الجوال
او التابلت الشخصي.</div>
...
او التابلت الشخصي.
    ...
    <div class="table hidden-xs" id="equipment" >
        <div class="table_row">
            <div class="table_cell">
                <p>كأجزاء مكونة لنظام "ترون" ، نحن نتستخدم المعدات المطابقة للمواصفة الاوروبية KNX تضم منظمة ال KNX اليوم أكثر
من 400 مصنع للمعدات و التجهيزات التقنية ، كل منهم يخضع لشروط اعتماد صارمة . لذلك عملاؤنا يحصلون دوما على
عروض متوازنة ينسجم فيها السعر مع الجودة والتصميم .</p>
                <p>جميع أجهزة الاستشعار و الحساسات و مفاتيح الاغلاق و كل المعدات المنفذة لوظائف النظام، تم إخضاعها لاختبارات المتانة
و السلامة و الديمومة و التحمل.</p>
            </div>
...
<div id="callback_wrapper">
    ...
    <div id="callback_form">
        <div class="footnote">أرسلو لنا مخطط العقار الخاص بكم على البريد الإلكتروني office@throne.pro ، وسنقوم بإنجاز نموذج تجريبي ثلاثي الأبعاد لعقاركم مع حساب للتكلفة التقديرية مجانا.</div>
        <div class="footnote">يرجى تسجيل معلومات الاتصال الخاصة بكم وتحديد موعد الإتصال المناسب لحضرتكم.</div>
        ...
        <div id="cb_form_body">
            <form action="" class="callback_form1" data-toggle="validator">
                <table>
                    ...
                    <tr><td>&nbsp;</td><td><button type="button" class="offer-send-btn" onclick="goog_report_conversion(); fbq('track', 'Lead'); yaCounter30996876.reachGoal('CALLBACK'); return true;">إرسال</button></td></tr>
                    </tbody>
                </table>
                ...
                <div class="row">
                    <div class="col-sm-7 col-xs-7">
                        <form action="" class=" callback_form" data-toggle="validator">
                            ...
                            <div class="form-group">
                                <div class="">
                                    <button type="button" class="send-btn">إرسال</button>
...
او بامكانكم التواصل عبر البريد الالكتروني بارسال رسالة مرفقة بمخطط المنزل او البناء و سنجيبكم على الفور بالتكلفة التقديرية
للمشروع مجانا
                        </div>
                    </div>
                </div>
