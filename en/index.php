    ...
    <div class="bcg" data-anchor-target="#slide-3" data-bottom-top="position: relative;  bottom: 0px;  " data--52-bottom="position: absolute;  bottom: 0px;">
        ...
        <div class="hsContainer visible-lg">
            <div class="hsContent">
                ...
                <p class="text-center" id="watch_video"><a href="http://www.youtube.com/embed/XYCeJh7gPts?autoplay=1" class="youtube">Watch video!</a><span id="watch_btn"></span></p>
                <div id="notes">
        ...
        <div class="hsContainer visible-md">
            <div class="hsContent">
                ...
                <p class="text-center" id="watch_video"><a href="http://www.youtube.com/embed/XYCeJh7gPts?autoplay=1" class="youtube">Watch video!</a><span id="watch_btn"></span>
                <div id="notes">
                    <div><img src="/images/interface_icon.png" class="img-responsive" alt=""/><span id="note1">Really Intuitive<br/>Interface</span></div>
                    <div><img src="/images/scale_icon.png" class="img-responsive" alt=""/><span id="note2">Any Size<br/>of a House</span></div>
                    <div><img src="/images/dist_manage_icon.png" class="img-responsive" alt=""/><span id="note3">Remote control from<br/>tablet or smartphone</span></div>
    ...
    <div id="callback_form">
        ...
        <form action="" class="callback_form1"  data-toggle="validator">
            <table>
                ...
                <tr class="form-group">
                    <td align="right"><label for="inputPhoneDemo" class="control-label">Phone number</label></td>
                ...
                <tr><td>&nbsp;</td><td><button type="button" class="offer-send-btn" onclick="goog_report_conversion(); fbq('track', 'Lead'); yaCounter30996876.reachGoal('CALLBACK'); return true;">Send</button></td></tr>
                </tbody>
            </table>

            <input type="hidden" name="inputTheme" value="Require 3D-demo">
        </form>
                ...
                <div class="row">
                    <div class="col-sm-7 col-xs-7">
                        <form action="" class=" callback_form"  data-toggle="validator">
                            ...
                            <div class="form-group">
                                <label for="inputPhoneCB" class="control-label">Cellphone Number</label>

                                <div class=" ">
                                    <input type="text" class="form-control" id="inputPhoneCB" name="inputPhone">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="">
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/565c5f1bfc4bd1b14399780e/default';
        s1.charset='UTF-8';
